...
console.log(1>0 && 10<=100); //true and false = false

console.log(1>0 && 10>=100); //true and true = true

console.log(1>0 && 10==100); //false and true = false

console.log(1<0 && 1>5); //false and false = false
...
console.log(1>0 || 10<=100); //true or false =  true

console.log(1>0 || 10>=100); //true or true =  true

console.log(1<0 || 10==100); //false or true =  true
